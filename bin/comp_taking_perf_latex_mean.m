...
function [tbl_meanstd_all, percentual, strategies] = generate_tbl_article(root, printing, env, env_abr, alg, withLoad, withNoise, exc, withlimiar, steps_counted, runs_number)
    ...
    for ig = 1:n_group
        for il = 1:n_load                       
            ...
            runs_generic = [group(ig) + load(il) + "1_j*.txt",...
                            group(ig) + load(il) + "2_j*.txt",...
                            group(ig) + load(il) + "3_j*.txt",...
                            group(ig) + load(il) + "4_j*.txt",...
                            group(ig) + load(il) + "5_j*.txt",...
                            group(ig) + load(il) + "6_j*.txt",...
                            group(ig) + load(il) + "7_j*.txt",...
                            group(ig) + load(il) + "8_j*.txt",...
                            group(ig) + load(il) + "9_j*.txt",...
                            group(ig) + load(il) + "10_j*.txt",...
                            group(ig) + load(il) + "11_j*.txt",...
                            group(ig) + load(il) + "12_j*.txt",...
                            group(ig) + load(il) + "13_j*.txt",...
                            group(ig) + load(il) + "14_j*.txt",...
                            group(ig) + load(il) + "15_j*.txt",...
                            group(ig) + load(il) + "16_j*.txt",...
                            group(ig) + load(il) + "17_j*.txt",...
                            group(ig) + load(il) + "18_j*.txt",...
                            group(ig) + load(il) + "19_j*.txt",...
                            group(ig) + load(il) + "20_j*.txt",...
                            group(ig) + load(il) + "21_j*.txt",...
                            group(ig) + load(il) + "22_j*.txt",...
                            group(ig) + load(il) + "23_j*.txt",...
                            group(ig) + load(il) + "24_j*.txt",...
                            group(ig) + load(il) + "25_j*.txt",...
                            group(ig) + load(il) + "26_j*.txt",...
                            group(ig) + load(il) + "27_j*.txt",...
                            group(ig) + load(il) + "28_j*.txt",...
                            group(ig) + load(il) + "29_j*.txt",...
                            group(ig) + load(il) + "30_j*.txt",...
                            group(ig) + load(il) + "31_j*.txt",...
                            group(ig) + load(il) + "32_j*.txt"];
