...
compare_executions(n, folder, 1, 909, 'Algoritmos Pendulum 3',...
    "pendulum_dpg_rand_sincos",...
    "old.del.pend3//pendulum_mpol_dpg_16_3_density_euclidian_distance_0.01_best_a0.01_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_mean_euclidian_distance_0.1_best_a0.01_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_mean_euclidian_distance_0.5_data_center_a0.01_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_mean_euclidian_distance_0.5_density_a0.01_pp0_");
compare_executions(n, folder, 1, 909, 'Algoritmos Pendulum 3',...
    "pendulum_dpg_rand_sincos",...pendulum_mpol_dpg_16_3_none_data_center_linear_order_1.0_best_a0.01_pp0_.yaml
    "old.del.pend3/pendulum_mpol_dpg_16_3_none_density_0.5_data_center_a0.01_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_none_density_0.5_density_a0.01_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_none_density_1.0_best_a0.01_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_none_none_1.0_data_center_a1.0_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_none_none_1.0_density_a1.0_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_none_none_1.0_mean_a1.0_pp0_",...
    "old.del.pend3/pendulum_mpol_dpg_16_3_none_none_1.0_random_a1_pp0_");
...
ploting_mpols(n, folder, subfolder, preffix, steps_per_second, type, title_fig,...    
              ...
              "_*_data_center_euclidian_distance_0.5_data_center_a0.01_",...
              "_*_none_data_center_linear_order_0.75_data_center_a0.01_",...
              "_*_data_center_euclidian_distance_0.75_data_center_a0.01_");
%%
env = "pendulum";
env_abr = "pd";
subfolder = env + "_mpols_yamls_results/";
...
title_fig = [env, "MPOL COMP datacenter 1/2 bad"];
array_runs = [subfolder + preffix + "bad_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "bad_*_data_center_euclidian_distance_0.25_data_center_a0.01_*.txt",...
              subfolder + preffix + "bad_*_data_center_euclidian_distance_0.5_data_center_a0.01_*.txt",...
              subfolder + preffix + "bad_*_data_center_euclidian_distance_0.75_data_center_a0.01_*.txt"];
ploting_executions(folder, title_fig, steps_per_second, array_runs);
%%
title_fig = [env, "MPOL COMP datacenter 2/2 bad"];
array_runs = [subfolder + preffix + "bad_*_data_center_euclidian_distance_0.5_data_center_a0.01_*.txt",...
              subfolder + preffix + "bad_*_none_data_center_linear_order_0.75_data_center_a0.01_*.txt",...
              subfolder + preffix + "bad_*_none_data_center_linear_order_0.5_data_center_a0.01_*.txt",...
              subfolder + preffix + "bad_*_none_data_center_linear_order_0.25_data_center_a0.01_*.txt"];
ploting_executions(folder, title_fig, steps_per_second, array_runs);
%%          
title_fig = [env, "MPOL COMP M\_ED\_50\_D good"];
array_runs = [subfolder + preffix + "good_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "r05good_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "r25good_*_mean_euclidian_distance_0.25_density_a0.01_*.txt",...
              subfolder + preffix + "r25good_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "r50good_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "good_*_none_density_linear_order_0.1_best_a0.01_*.txt",...
              subfolder + preffix + "good_*_none_density_linear_order_0.5_data_center_a0.01_*.txt",...
              subfolder + preffix + "good_*_none_density_linear_order_0.5_density_a0.01_*.txt"];
ploting_executions(folder, title_fig, steps_per_second, array_runs);
%%
title_fig = [env, "MPOL COMP M\_ED\_50\_D mid"];
array_runs = [subfolder + preffix + "mid_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "r05mid_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "r25mid_*_mean_euclidian_distance_0.25_density_a0.01_*.txt",...
              subfolder + preffix + "r25mid_*_mean_euclidian_distance_0.5_density_a0.01_*.txt"];
ploting_executions(folder, title_fig, steps_per_second, array_runs);

title_fig = [env, "MPOL COMP M\_ED\_50\_D bad"];
array_runs = [subfolder + preffix + "bad_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "r05bad_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "r25bad_*_mean_euclidian_distance_0.25_density_a0.01_*.txt",...
              subfolder + preffix + "r25bad_*_mean_euclidian_distance_0.5_density_a0.01_*.txt",...
              subfolder + preffix + "r50bad_*_mean_euclidian_distance_0.5_density_a0.01_*.txt"];
ploting_executions(folder, title_fig, steps_per_second, array_runs);
%%
env = "pendulum";
env_abr = "pd";
...
preffix = env + "_" + env_abr + "_tau_mpol_replay_ddpg_tensorflow_sincos_16";
type = "bad";
title_fig = [env, "MPOL BAD DATA 025 DATA"];

ploting_mpols(n, folder, subfolder, preffix, steps_per_second, type, title_fig,...
              "_*_data_center_euclidian_distance_0.1_best_a0.01_",...
              "_*_data_center_euclidian_distance_0.5_data_center_a0.01_",...
              "_*_mean_euclidian_distance_0.25_density_a0.01_",...
              "_*_none_data_center_linear_order_0.5_data_center_a0.01_",...
              "_*_none_data_center_linear_order_0.5_density_a0.01_",...
              "_*_data_center_euclidian_distance_0.25_data_center_a0.01_",...
              "_*_data_center_euclidian_distance_0.5_data_center_a0.02_",...
              "_*_none_data_center_linear_order_0.25_data_center_a0.01_");
...
ploting_mpols(n, folder, subfolder, preffix, steps_per_second, type, title_fig,...
              "_*_mean_euclidian_distance_0.25_density_a0.01_",...
              "_*_data_center_euclidian_distance_0.1_best_a0.02_",...
              "_*_data_center_euclidian_distance_0.5_data_center_a0.01_",...
              "_*_data_center_euclidian_distance_0.25_data_center_a0.01_");
%%
env = "pendulum";
...
preffix = env + "_" + env_abr + "_tau_mpol_replay_ddpg_tensorflow_sincos_16";
type = "bad";
title_fig = [env, "MPOL BESTS of ", type];
ploting_mpols(n, folder, subfolder, preffix, steps_per_second, type, title_fig,...
              "_*_mean_euclidian_distance_0.25_density_a0.01_",...
              "_*_data_center_euclidian_distance_0.5_data_center_a0.01_",...
              "_*_data_center_euclidian_distance_0.25_data_center_a0.01_",...
...
ploting_mpols(n, folder, subfolder, preffix, steps_per_second, type, title_fig,...
              ...
              "_*_data_center_euclidian_distance_0.5_data_center_a0.01_",...
              "_*_mean_euclidian_distance_0.25_density_a0.01_",...
              "_*_mean_euclidian_distance_0.75_density_a0.01_",...
              "_*_none_data_center_linear_order_0.5_data_center_a0.01_",...
              "_*_none_data_center_linear_order_0.5_density_a0.01_",...
              "_*_data_center_euclidian_distance_0.25_data_center_a0.01_",...
              "_*_none_data_center_linear_order_0.25_data_center_a0.01_");
...
env = "pendulum";
env_abr = "pd";
subfolder = env + "_mpols_alphas_yamls_results/";
preffix = env + "_" + env_abr + "_tau_mpol_replay_ddpg_tensorflow_sincos_16";
type = "bad";
title_fig = [env, "MPOL ", type];
ploting_mpols(n, folder, subfolder, preffix, steps_per_second, type, title_fig,...
