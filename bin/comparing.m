...
%%
compare_executions(n, folder, 'MPOL DPG 13 benchmark',...
    "pendulum_ac_tc", "mpol_dpg_13_density_based_mm_a01_data",...
    "pendulum_dpg.dat", ...
...
compare_executions(n, folder, 'MPOL DPG 13 density based bm',...
    "mpol_dpg_13_density_based_mm_a001_data", "mpol_dpg_13_density_based_mm_a01_data",...
    "mpol_dpg_13_density_based_mm_a75_data", "mpol_dpg_13_density_based_mm_a90_data");

%%
%"mpol_dpg_20_density_based_data",
compare_executions(n, folder, 'MPOL DPG 20 density based',...
    "pendulum_ac_tc", "pendulum_dpg.dat",...
    "mpol_dpg_20_density_based_mm_a001_data","mpol_dpg_20_density_based_mm_a001_data",...
    "mpol_dpg_20_density_based_mm_a01_data");
