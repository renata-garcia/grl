    ...
    for ig = 1:n_group
        for il = 1:n_load                       
            ...
            runs_generic = [group(ig) + load(il) + "_*_none_none_1.0_data_center_a1.0_-*txt",...
                            group(ig) + load(il) + "_*_none_none_1.0_density_a1.0_-*txt",...
                            group(ig) + load(il) + "_*_none_none_1.0_mean_a1.0_-*txt",...
                            group(ig) + load(il) + "_*_none_data_center_linear_order_1.0_best_a1.0*txt",...
                            group(ig) + load(il) + "_*_none_data_center_linear_order_0.25_data_center_a1.0*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.25_data_center_a1.0*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.1_best_a1.0*txt",...
                            group(ig) + load(il) + "_*_density_euclidian_distance_0.01_best_a1.0*txt",...
                            group(ig) + load(il) + "_*_none_density_linear_order_1.0_best_a1.0*txt",...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_0.1_best_a1.0*txt",...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_0.25_density_a1.0*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.2_best_elitism005_a1.0*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.2_best_elitism0001_a1.0*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.1_best_persistent_a1.0*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.1_best_delay_persistent_a1.0*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.1_best_dc_persistent_a1.0*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.1_best_d_persistent_a1.0*txt",...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_0.25_mean_a1.0*txt",...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_0.25_data_center_a1.0*txt",...
                            group(ig) + load(il) + "_*_none_density_linear_order_0.25_density_a1.0*txt"];
    ...
    for ig = 1:n_group
        for il = 1:n_load                       
            ...
            runs_generic = [group(ig) + load(il) + "_*_none_none_1.0_data_center_a1.0_-*txt",...
                            ...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_0.1_best_a0.01_-*txt",...
                            group(ig) + load(il) + "_*_none_data_center_linear_order_0.25_data_center_a0.01_-*txt",...
                            group(ig) + load(il) + "_*_none_density_linear_order_0.25_density_a0.01_-*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.25_data_center_a0.01_-*txt",...                            
                            group(ig) + load(il) + "_*_none_data_center_linear_order_0.25_data_center_a0.01_-*txt",...
                            group(ig) + load(il) + "_*_none_density_linear_order_0.25_density_a0.01_-*txt",...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_0.25_mean_a0.01_*txt",...                            
                            ...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_0.5_mean_a0.01_*txt",...                            
