    ...
    for ig = 1:n_group
        for il = 1:n_load                       
             ...
             runs_generic = [group(ig) + load(il) + "_*_none_none_1.0_data_center_a1.0_-*txt",...
                            ...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_1.0_best_persistent_a0.01_*txt",...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_1.0_best_elitism_a0.01_*txt",...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_1.0_best_delay_persistent_a0.01_*txt",...
                            group(ig) + load(il) + "_*_data_center_euclidian_distance_0.1_best_dc_persistent_a0.01_*txt",...
                            group(ig) + load(il) + "_*_mean_euclidian_distance_1.0_best_dc_persistent_a0.01_*txt"];
            i_load = (ng*n_load) + ng*(il-1) + (2*ig)-1; %(ng*n_load)*(ie-1) + ng*(il-1) + (2*ig)-1
            j_load = (ng*n_load) + ng*(il-1) + (2*ig); %(ng*n_load)*(ie-1) + ng*(il-1) + (2*ig)
            i = nl*(ig-1) + 2*il -1; %(ng*n_load)*(ie-1) + 
            j = nl*(ig-1) + 2*il;%(ng*n_load)*(ie-1) + 
