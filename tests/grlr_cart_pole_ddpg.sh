...
cp ~/projects/grl/cfg/cart_pole/env_cart_pole.yaml ~/projects/grl/build
cp ~/projects/grl/cfg/cart_pole/agent_replay_ddpg_tensorflow_geometric.yaml ~/projects/grl/build
../bin/grlr ../bin/spec_cart_pole_replay.yaml